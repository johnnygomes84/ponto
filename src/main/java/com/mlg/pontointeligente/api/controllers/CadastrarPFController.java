...
import com.mlg.pontointeligente.api.dtos.CadastroPFDto;
...
@CrossOrigin(origins = "*")
public class CadastrarPFController {
	
	private static final Logger log = LoggerFactory.getLogger(CadastrarPFController.class);
